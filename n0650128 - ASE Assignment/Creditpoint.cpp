...
CreditPoint::CreditPoint(dateStruct date, timeStruct time, float Value, std::string payment)
{
...
std::string CreditPoint::getID()
{
	return paymentType;
}

std::string CreditPoint::getType()
{
	return "creditpoint";
}

float CreditPoint::getValue()
{
	return value;
}

void CreditPoint::saveTransaction()
{
