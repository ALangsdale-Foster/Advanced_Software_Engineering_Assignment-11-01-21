...
Interest::Interest(dateStruct date, timeStruct time, float Value, std::string interest)
{
...
void Interest::display()
{
	...
	std::cout << "Interest Type: " << interestType << std::endl;
}

std::string Interest::getID()
{
	return interestType;
}

std::string Interest::getType()
{
	return "interest";
}

float Interest::getValue()
{
	return value;
}

void Interest::saveTransaction()
{
